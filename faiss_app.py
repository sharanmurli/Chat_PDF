...
def get_vector_store(text_chunks):
    ...
    vector_store.save_local("faiss_index")  # Corrected typo here
...
# Add caching to the function that handles user input and API calls
@st.cache_data
...
def user_input(user_question):
    response_text = cached_user_input(user_question)
    st.write("Reply: ", response_text)

def main():
    st.set_page_config(page_title="Chat PDF")  #
    st.header("Chat with PDF using Gemini , Langchain and FAISS")
